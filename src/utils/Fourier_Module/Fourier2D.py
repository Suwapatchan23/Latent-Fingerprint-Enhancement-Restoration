...
class Fourier2D:
    ...
    def fft(self):
        ...
        self.__winfunc_img = self.__windowFunction(zero_img)
        # -> Forward 2D-Fourier Transform
        fft_complex = fftpack.fft2(self.__winfunc_img)
    ...
    # <-----------------------------> API Function <------------------------------>
    # ---> GET API
    def getWindowing(self):
        '''
            Get Windowing spatial image
        '''
        return self.__winfunc_img
